...
import { Target, Sparkles, Star, Crown } from 'lucide-react';
import { gsap } from 'gsap';

/**
 * Signup page component - Luxury animated signup
 */
export default function SignupPage() {
  ...
  useEffect(() => {
    ...
    // Rotating orbits at different speeds
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="mb-8 text-center animate-fade-in">
          <div className="relative mx-auto w-32 h-32 flex items-center justify-center">
            ...
            <div ref={orbitRef3} className="absolute inset-0">
              <div className="absolute left-0 top-1/2 -translate-y-1/2 w-3 h-3 bg-gradient-to-r from-amber-400 to-yellow-400 rounded-full shadow-lg"></div>
            </div>
            ...
            >
              <Crown className="h-10 w-10 text-white" aria-hidden="true" />
            </div>
          </div>
          ...
          <div className="flex items-center justify-center gap-2 mt-4">
            ...
            <p className="text-gray-700 text-lg">
              Create your account and achieve excellence
            </p>
            <Star className="w-5 h-5 text-amber-600" />
          </div>
        </div>

        {/* Signup Form Card with Luxury Style */}
